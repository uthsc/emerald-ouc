...
<script>
    ...
    function renderEducationPosts() {
        newsAjax("http://news.uthsc.edu/wp-json/wp/v2/posts?categories=59&per_page=3&_embed", '.news-posts-academics');
    }

    function renderResearchPosts() {
        newsAjax("http://news.uthsc.edu/wp-json/wp/v2/posts?categories=60&per_page=3&_embed", '.news-posts-research');
    }

    function renderClinicalCarePosts() {
        newsAjax("http://news.uthsc.edu/wp-json/wp/v2/posts?categories=61&per_page=3&_embed", '.news-posts-clinical-care');
    }

    function renderPublicServicePosts() {
        newsAjax("http://news.uthsc.edu/wp-json/wp/v2/posts?categories=331&per_page=3&_embed", '.news-posts-public-service');
    }
