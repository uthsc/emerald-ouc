    ...
    <nav class="uthsc-site-nav hide-for-print" aria-label="UTHSC site menu" role="navigation">
        ...
        <div class="uthsc-site-nav-right">
            <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
                ...
                <li><a href="/give/"><span class="fa fa-gift" aria-hidden="true"></span> Make a Gift</a></li>
                <li><a href="/admissions/visit-uthsc.php"><span class="fa fa-road" aria-hidden="true"></span> Take a Tour</a></li>
                <li>
        ...
        <nav id="uthsc-section-navigation" data-equalizer="nested-links" aria-label="Current section menu"
            ...
            <ul class="row collapse" >
                <li class="uthsc-navigation-column small-2 columns">
                    <a href="http://uthsc.edu/nursing/about-the-college/index.php" data-equalizer-watch="heading-links">About</a>
                ...
                <li class="uthsc-navigation-column small-2 columns">
                    <a href="http://uthsc.edu/nursing/academic-programs/index.php" data-equalizer-watch="heading-links">Academic Programs</a>
                    <ul data-equalizer-watch="nested-links"></ul>
                </li>

                <li class="uthsc-navigation-column small-2 columns">
                    <a href="http://uthsc.edu/nursing/research-programs/index.php" data-equalizer-watch="heading-links">Research Programs</a>
                    <ul data-equalizer-watch="nested-links">
                ...
                <li class="uthsc-navigation-column small-2 columns">
                    <a href="http://uthsc.edu/nursing/practice-programs/index.php" data-equalizer-watch="heading-links">Practice Programs</a>
                    <ul data-equalizer-watch="nested-links"></ul>
                </li>

                <li class="uthsc-navigation-column small-2 columns">
                    <a href="http://uthsc.edu/nursing/continuing-education/index.php" data-equalizer-watch="heading-links">Continuing Education</a>
                    <ul data-equalizer-watch="nested-links">
    ...
    <div class="main-content" id="main-content" aria-label="Page content" role="main">
        ...
        <div class="row">
            <div class="columns uthsc-row-title">
                <h1>UTHSC College of Nursing</h1>
            </div>
        </div>
        <!--***********-->
        <!--/Page title-->
                ...
                <div class="columns">
                    <div class="uthsc-page-opening">
                        ...
                        <p class="uthsc-page-lead">We were the first nursing school in the Mid-South. We have lead the way by
                            ...
                            nursing today and in the future.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="columns">
                            ...
                            <div class="uthsc-highlight-box">
                                <a href="https://www.uthsc.edu/research/research_compliance/irb/">
                                    ...
                                    <div class="uthsc-highlight-box-title">
                                        <p>Doctor of Nursing Practice Program</p>
                                    </div>

                                    <div class="uthsc-highlight-box-description">
                                        <p>Our DNP program is offered mostly online and is perfect for experienced RNs
                                            who want to take their careers to the next level by earning a Doctor of
                                            Nursing Practice degree. </p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="columns">
                            ...
                            <div class="uthsc-highlight-box  uthsc-highlight-box-green">
                                <a href="https://www.uthsc.edu/nursing/future-students/admissions/dnp_anesthesia_req.php">
                                    ...
                                    <div class="uthsc-highlight-box-description">
                                        <p>UTHSC College of Nursing offers two paths to the Doctor of Nursing Practice
                                            CRNA degree, depending on your prior training</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="columns">
                            ...
                            <div class="uthsc-highlight-box uthsc-highlight-box-purple">
                                <a href="">
                                    ...
                                    <div class="uthsc-highlight-box-description">
                                        <p>We offer an Adult Gerontology – Acute Care Nurse Practitioner certificate
                                            for Advanced Practice Nurses who want to acquire the skills necessary to
                                            provide patient-centered care to adults across the
                                            lifespan.</p>
                                    </div>
                                </a>
                            </div>
